...
<head>
    ...
    <style>
        ...
        .article-add .ke-container-example1 .ke-toolbar{
            background-color: #efe1e1;
        }
        .article-add .ke-toolbar .ke-outline{
            padding: 4px 8px;
        }
        .article-add .ke-container{
            margin: 0px auto;
        }
        .article-add .t{
            width: 1000px;
        ...
        .article-add .iuuse select{
            width: 170px;
            padding: 10px 10px;
            background-color: #efe1e1;
            font-size: 16px;
        }
        .article-add .iuuse select option{
            font-size: 16px;
        }
        .article-add .iuuse button{
            margin-left: 220px;
            padding: 4px;
            width: 60px;
...
<div class="article-add">
    <div class="t">
        <input type="text" placeholder="输入博客标题，上限100个字" class="title">
    </div>
...
<#if article ??>
    <div class="edit" style="display: none">
        ...
        <label class="programaId">${article.programaId}</label>
